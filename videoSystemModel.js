...
const VideoSystem = (function () {
  ...
  class VideoSystem {
    ...
    constructor() {
      ...
      //Getter directors. Devuelve iterador que permite recorrer los actores
          ...
          return {
            *[Symbol.iterator]() {
              for (const storedDirectors of values) {
                yield storedDirectors.director;
              }
            },
          };
        },
    ...
    *getProductionsCategory(category) {
    ...
    //  si está creado y si no lo crea, pero no lo añade al manager
    createCategory(name, description) {
      ...
      this.#categories.set(key, {
        category,
        productions: new Map(),
      }); // Metemos en el map con la clave
